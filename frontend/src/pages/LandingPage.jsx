...
export default function LandingPage() {
  ...
  const calculateSIP = async () => {
    setSipLoading(true);
    try {
      const res = await axios.post('http://localhost:8000/api/sip', {
  ...
  const calculateFDLiquidation = async () => {
    setFdLoading(true);
    try {
      const res = await axios.post('http://localhost:8000/api/fd/liquidation', {
  ...
  const predictAssets = async () => {
    ...
    try {
      const res = await axios.post('http://localhost:8000/api/predict/assets', {
  ...
  const sendChat = async (e, textOverride = '') => {
    ...
    try {
      const res = await axios.post('http://localhost:8000/api/chat', { message: query });
