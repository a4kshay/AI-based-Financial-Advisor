...
- **Backend**: Built with Python and FastAPI. It handles business logic and API endpoints.
...
- **`App.jsx`**: The main router file. It defines the navigation paths.
...
- **`Dashboard.jsx`**: The main hub showing a summary of the user's financial health, trending stocks, and market indices.
...
## 2. Backend (`/backend`)
The backend serves as the bridge between the external financial data APIs (like Yahoo Finance) and the frontend.
